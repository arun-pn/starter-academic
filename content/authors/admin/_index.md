...
- icon: graduation-cap  # Alternatively, use `google-scholar` icon from `ai` icon pack
  icon_pack: fas
  link: https://scholar.google.com/citations?user=6khJPg0AAAAJ&hl=en&oi=ao
- icon: github
  icon_pack: fab
  link: https://github.com/arun-pn
- icon: linkedin
  icon_pack: fab
  link: https://www.linkedin.com/in/arun-pankajakshan-b03225b3/
